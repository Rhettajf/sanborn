    <div class="row"> 
        <div class="large-4 column">
            <h2>SANBORN ARCHIVES</h2>
            <img src="img/hr2.svg" alt="header" class="hr">
<select name="pickstate" id="pickstate" class="mobile-only ">
<option value="" disabled selected>Explore a Mapped State</option>
...
<tr>
    <th>STATE</th>
    <th>MAPPED</th>
    <th data-sort-initial-order="desc">PAGES</th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
    <td><a href="states/TEXAS">Texas</a></td>
    <td>yes</td>
    <td>12</td>
</tr>
<tr>
